...
void PartitionFrame::initUI() {
  ...
  full_disk_frame_button_->setObjectName("left_frame_button");
  ...
  simple_frame_button_->setObjectName("mid_frame_button");
  ...
  advanced_frame_button_->setObjectName("right_frame_button");
