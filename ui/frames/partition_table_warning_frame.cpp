...
void PartitionTableWarningFrame::initUI() {
  ...
  QLabel* left_label = new QLabel(tr("A.Disable UEFI"));
  ListLabel* list_label1 = new ListLabel(
      tr("Reboot, enter BIOS, and disable UEFI"));
  ListLabel* list_label2 = new ListLabel(
      tr("Exit BIOS, and enter deepin installation"));
  QLabel* left_label2 = new QLabel(tr("Format the disk"));
  ...
  QLabel* right_label = new QLabel(tr("Continue"));
  ...
  ListLabel* list_label6 = new ListLabel(
      tr("Continue installation will format your disk"));
  ...
  content_layout->setHorizontalSpacing(30);
