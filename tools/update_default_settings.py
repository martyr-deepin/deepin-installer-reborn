...
def main():
    ...
    loongson_settings = (
            ...
            ("partition_full_disk_small_legacy_policy", '"/boot:ext4:1:800;linux-swap:linux-swap:801:linux-swap-end;/:ext4:100%"'),
            ("partition_full_disk_large_legacy_policy", '"/boot:ext4:1:800;linux-swap:linux-swap:801:linux-swap-end;/:ext4:75%;:ntfs:100%"'),
